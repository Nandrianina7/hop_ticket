...
//   useAnimatedStyle,
//   withTiming,
//   runOnJS, // ✅ NEW: permet d'appeler JS depuis un gesture
// } from "react-native-reanimated";
// import { Gesture, GestureDetector } from "react-native-gesture-handler";
// import SeatItem, { SeatState } from "./SeatItem";
// import { Seat, SeatingLayout, Section } from "./type";
...
//     const minY = Math.min(...normalized.sections.map((s) => s.y));
//     const maxX = Math.max(
//       ...normalized.sections.map((s) => s.x + s.width)
//     );
//     const maxY = Math.max(
//       ...normalized.sections.map((s) => s.y + s.height)
//     );
...
//   const pan = Gesture.Pan()
//     .minDistance(10) // ✅ NEW: évite qu'un tap soit interprété comme un pan
//     .averageTouches(true)
//     .onStart(() => {
//       lastX.value = translateX.value;
//       lastY.value = translateY.value;
...
//   // ✅ NEW: Exclusive permet aux taps (seats) de passer
...
//             pointerEvents="box-none" // ✅ NEW: laisse passer les events aux seats
//           >
//             {normalized.sections.map((sec) => (
//               <G key={sec.id}>
//                 <SectionItem
